...
export default class App extends Component{
  ...
  var b_uid = this.props.b_uid
    ...
    console.log(" props on App.js  : " , b_uid ) 
        ...
        firebase.firestore().collection('business_page').doc(b_uid).onSnapshot(doc => {
          
          this.setState({ business: doc.data(), timing:doc.data().timing, pv:doc.data().Page_Visit,length_like : doc.data().Page_Like.length ,    }); 


          console.log("business_uid data : " + doc.data().uid)
